...
if st.button("Search"):
    ...
    with st.spinner("Summarizing..."):
        try:
            ...
            DO NOT include "As a {plain_enlgish_role} employee," (or anything similar) in your response, or you will have failed the task.
            DO NOT include "Based on the context provided" (or anything similar) in your response, or you will have failed the task.
            ---
